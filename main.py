...
# Start of making svd
# Circle-graph
            dwg = svgwrite.Drawing('step' + str(n + 1) + '.svg', size=("1024px", "960px"))
...
# Rectangle graph
            dwg = svgwrite.Drawing('step' + str(n+1) + '_rect.svg', size=("1024px", "960px"))
            dwg.add(dwg.rect(insert=(30, 30),
                             size=("770px", "670px"),
                             stroke_width="1",
                             stroke="black",
            ...
            dwg.save()
# Circle final
        dwg = svgwrite.Drawing('graphCircle_final.svg', size=("1024px", "960px"))
        dwg.add(dwg.rect(insert=(30, 30),
                         size=("770px", "670px"),
                         stroke_width="1",
                         stroke="black",
        ...
        dwg.save()
# Rectangle final
        dwg = svgwrite.Drawing('graphRect_final.svg', size=("1024px", "960px"))
        dwg.add(dwg.rect(insert=(30, 30),
                         size=("770px", "670px"),
                         stroke_width="1",
                         stroke="black",
    ...
    def graphToSVG(self):
# Circle-graph
        dwg = svgwrite.Drawing('graph.svg', size=("1024px", "960px"))
        dwg.add(dwg.rect(insert = (30, 30),
                                   size = ("770px", "670px"),
                                   stroke_width = "1",
                                   stroke = "black",
        ...
        dwg = svgwrite.Drawing('graph_rect.svg', size=("1024px", "960px"))
        dwg.add(dwg.rect(insert=(30, 30),
                         size=("770px", "670px"),
                         stroke_width="1",
                         stroke="black",
